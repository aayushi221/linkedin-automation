...
#after running this line ,terminal will ask you to enter you desired company's employee you want to send connection request to
driver.get('https://www.linkedin.com/search/results/people/?keywords={}&network=%5B%22S%22%5D&origin=FACETED_SEARCH'.format(input("enter your desired company: ")))    
